  ...
  <div class="container navbar navbar-default navbar-static-top">
    ...
    <form role="search" method="get" class="navbar-form navbar-right search-form form-inline" action="<?php echo esc_url(home_url('/search')); ?>">
      ...
      <div class="input-group">
        <input type="search" value="<?php echo htmlentities(isset($_REQUEST['q'])?$_REQUEST['q']:''); ?>" name="q" class="search-field form-control" placeholder="Search all blogs" required>
